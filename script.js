...
async function searchCharacter(){
    ...
    try {
        const response= await fetch("https://cors-anywhere.herokuapp.com/https://open.api.nexon.com/maplestory/v1/id?character_name="+nickname,{headers :{
        ...
        resultDiv.innerHTML = `<p>캐릭터 이름: ${data.ocid} </p>`;
    }
